...
<div class="page-content mt-3">
        <div class="col-lg-7 m-auto mt-5">
            <div class="summary summary-cart">
                ...
                <p class="ft-regular fs-md">Your order <span class="text-body text-dark">{{ session('order_id') }}</span> has been completed. Your order details are shown for your personal accont.</p>
