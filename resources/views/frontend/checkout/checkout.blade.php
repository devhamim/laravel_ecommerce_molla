                            ...
                            <table class="table table-summary">
                                ...
                                <tbody>
                                    ...
                                    <tr class="summary-shipping-row">
                                        <td>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="charge" id="standart-shipping" checked="" class="custom-control-input" value="100">
                                ...
                                <div class="card">
                                  ...
                                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body pt-2">
                                        <p>Please complete your bKash payment first, then fill up the form below.
                                            bKash Personal Number: 01303523442</p>
