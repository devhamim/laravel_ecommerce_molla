    ...
    <div class="heading heading-flex heading-border">
        <div class="heading-left">
            <div class="heading-left-inner d-flex align-items-center">
                <h2 class="title">Flash Sale <span class="pl-xl-5 pl-md-5 pl-sm-4">Ending In</span></h2>
                @if ( $discount_products != '' && $discount_products->first() != null)
                    <span class="deal-countdown offer-countdown" data-until="+{{Carbon\Carbon::now()->diffInHours($discount_products->first()->validity, false)}}h"></span>
                @else
                    <span class="deal-countdown offer-countdown" data-until=""></span>
                @endif
            </div>
        </div>
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-13/products/product-4.jpg" alt="Product image" class="product-image">
                        </a>

                        <div class="product-action-vertical">
                            <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                            
                            <a href="{{route('product_quick_view', $products->first()->id)}}" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                        </div>
                ...
                <div class="product">
                    <figure class="product-media">
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-13/products/product-1.jpg" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-13/products/product-2.jpg" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product">
                    <figure class="product-media">
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-13/products/product-3.jpg" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product">
                    <figure class="product-media">
                        ...
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-13/products/product-5.jpg" alt="Product image" class="product-image">
                        </a>
...
<div class="heading heading-flex heading-border ">
   ...
   <div class="heading-right">
        <a href="{{route('shop')}}" class="see_more"><h3 class="me-1">See More</h3><span>></span></a>
   </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-6">
                <div class="product demo21">
                    <figure class="product-media">
                        <span class="product-label label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-21/newArrivals/product-2.jpg" alt="Product image" class="product-image">
                        </a>
            ...
            <div class="col-lg-2 col-md-3 col-6">
                <div class="product demo21">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('frontend') }}/assets/images/demos/demo-21/newArrivals/product-6.jpg" alt="Product image" class="product-image">
                        </a>
