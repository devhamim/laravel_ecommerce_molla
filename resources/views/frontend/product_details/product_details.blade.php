                        ...
                        <form action="{{route('buy.store')}}" method="POST">
                            ...
                            <div class="product-details">
                                    ...
                                    <div class="product-nav product-nav-thumbs">
                                        ...
                                        <div class="select-custom">
                                            @php
                                                $color = null;
                                            @endphp
                                            @if($available_colors->first()->color_id != 0)
                                            <select name="color" class="form-control colorId" id="colorId">
                                                <option value="">Select a color</option>

                                                @foreach ($available_colors as $color)
                                                        <option value="{{$color->color_id}}" name="color_id">{{$color->rel_to_color->color_name}}</option>
                                    ...
                                    <div class="obd-pre-order-product-details-prod-short-desc-call"> 
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="social-media-business d-flex pl-5 align-items-center justify-content-center">
                                                ...
                                                {{-- <a href="https://api.whatsapp.com/send?text={{ urlencode($product_info->first()->product_name) }}&amp;url={{ urlencode(route('product.details',$product_info->first()->slug)) }}" target="_blank"><i class="icon-whatsapp"></i></a> --}}
                                                ...
                                                {{-- <a href=""><i class="icon-facebook-messenger"></i></a> --}}
                                            </div>
                                        </div>
                                ...
                                <div class="product-details-action mt-3">
                                    <button type="submit" class="btn-product btn-cart btn-buy mr-5" name="btn" value="2"><span>Buy now</span></button>
                                    <button type="submit" class="btn-product btn-cart" name="btn" value="1" id="load"><span>add to cart</span></button>
