...
<div class="container-fluid flex-grow-1 container-p-y pt-5">
    <div class="row">
        ...
        <div class="card mb-4">
            <h6 class="card-header">terms & Condition</h6>
            <div class="card-body">
                <form method="POST" action="{{route('terms.conditions.update', $terms_conditions->first()->id)}}" >
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="summernote" name="terms_Condition" class="form-control" placeholder="terms & Condition">{!! $terms_conditions->first()->terms_Condition !!}</textarea>
